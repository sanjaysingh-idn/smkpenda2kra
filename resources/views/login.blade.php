...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('temp_back') }}/assets/" data-template="vertical-menu-template-free">

    <head>
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

        <title>SMK Penda 2 Karanganyar - Login Admin</title>
        ...
        <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('template/assets/img/favicon') }}/apple-icon-152x152.png">
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('template/assets/img/favicon') }}/apple-icon-180x180.png">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <div class="fs-4 fw-bold my-3">
                                    Halaman Login SMK Penda 2 Karanganyar
                                </div>
                            </div>
                            <!-- /Logo -->
                            ...
                            <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" autofocus>
                                    @error('email')
                            ...
                            <div class="my-3">
                                <small>Belum punya akun ? silahkan daftar <a href="{{ route('register') }}">disini</a></small>
                            </div>
                            <div class="my-3">
