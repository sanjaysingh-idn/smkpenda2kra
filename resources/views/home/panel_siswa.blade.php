...
<section id="about">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-sm-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <img src="{{ asset('storage/'. $pendaftaran->pas_foto) }}" alt="Foto {{ $pendaftaran->nama }}" class="rounded-circle img-fluid" style="width: 150px;">
                    </div>
                </div>
                <div class="card mb-4">
                    <div class="card-body text-center">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">{{ $pendaftaran->tempat_lahir }}, {{ date('d F Y', strtotime($pendaftaran->tanggal_lahir)); }}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
            ...
            @else
            <p>Anda belum melakukan pendafaran siswa baru. Silahkan melakukan pendaftaran <a href="{{ url('pendaftaran-siswa') }}">disini</a></p>
            @endif
        </div>
    </div>
</section>
