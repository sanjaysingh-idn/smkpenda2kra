...
<section id="about">
    <div class="container">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            <strong>Pendaftaran Siswa Berhasil!</strong> Pendaftar yang diterima akan dihubungi melalui whatsapp dan email segera.
        </div>
        @endif
                ...
                <span data-aos="fade-down">
                    <div class="row">
                        ...
                        <div class="col-12">
                                ...
                                <form method="post" action="{{ route('pendaftaran-siswa.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input class="form-control form-control-lg bg-citrine @error('pas_foto') is-invalid @enderror" id="formFileLg" name="pas_foto" type="file" accept="image/*" required>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="number" class="form-control @error('nisn') is-invalid @enderror" name="nisn" id="nisn" value="{{ old('nisn') }}" maxlength="10" required>
                                            @error('nisn')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <input type="type" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir') }}" required>
                                            @error('tempat_lahir')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="number" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp" id="no_telp" value="{{ old('no_telp') }}" required maxlength="13">
                                            @error('no_telp')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('asal_sekolah') is-invalid @enderror" name="asal_sekolah" id="asal_sekolah" value="{{ old('asal_sekolah') }}" required>
                                            @error('asal_sekolah')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="number" class="form-control @error('nik') is-invalid @enderror" name="nik" id="nik" value="{{ old('nik') }}" maxlength="16" required>
                                            @error('nik')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('pekerjaan_ayah') is-invalid @enderror" name="pekerjaan_ayah" id="pekerjaan_ayah" value="{{ old('pekerjaan_ayah') }}" required>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('pekerjaan_ibu') is-invalid @enderror" name="pekerjaan_ibu" id="pekerjaan_ibu" value="{{ old('pekerjaan_ibu') }}" required>
                                            @error('pekerjaan_ibu')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="number" class="form-control @error('no_telp_ortu') is-invalid @enderror" name="no_telp_ortu" id="no_telp_ortu" value="{{ old('no_telp_ortu') }}" maxlength="13" required>
                                            @error('no_telp_ortu')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            @else
                            <p>Anda sudah mendaftar, silahkan ke halaman <a href="{{ route('panel-siswa', ['id' => Auth::id()]) }}">panel siswa</a> untuk cek status pendaftaran</p>
                            @endif
                        </div>
                    </div>
                </span>
