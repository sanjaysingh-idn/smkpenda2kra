            ...
            <div class="col-md-9">
                <span data-aos="fade-down">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <a href="{{ route('informasi.berita', ['slug' => $item->slug]) }}" class="text-decoration-none">
                                <div class="card mb-5 border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="{{ asset('storage/'. $item->foto) }}" class="rounded-start img-fluid h-100" style="object-fit: cover" alt="...">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <small>
