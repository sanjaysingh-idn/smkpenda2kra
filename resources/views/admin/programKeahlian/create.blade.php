	...
	<div class="row">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="{{ route('admin.program-keahlian.store') }}" enctype="multipart/form-data">
						@csrf
							...
							<div class="row">
								<div class="col-sm-6 mb-3">
									...
									<input type="text" class="form-control @error('nama_program') is-invalid @enderror" name="nama_program"
										id="nama_program" value="{{ old('nama_program') }}">
									@error('nama_program')
								...
								<div class="col-sm-6 mb-3">
									...
									<img src="{{ asset('storage/img/image.jpg') }}" alt="default-image" class="d-block rounded" height="100"
										id="uploadedFoto" />
