	...
	<div class="row">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="{{ route('admin.program-keahlian.update', ['program_keahlian' => $program->id]) }}"
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-6 mb-3">
									...
									<input type="text" class="form-control @error('nama_program') is-invalid @enderror" name="nama_program"
										id="nama_program" value="{{ $program->nama_program }}">
									@error('nama_program')
								...
								<div class="col-sm-6 mb-3">
									...
									<input type="text" class="form-control @error('singkatan') is-invalid @enderror" name="singkatan"
										id="singkatan" value="{{ $program->singkatan }}">
									@error('singkatan')
										<div class="invalid-feedback">
											{{ $message }}
										</div>
								...
								<div class="col-sm-6 mb-3">
									...
									<img src="{{ asset('storage/' . $program->foto_utama) }}" alt="Foto {{ $program->judul }}"
									...
									<label for="foto_utama" class="btn btn-primary me-2 mb-4" tabindex="0">
										...
										<input type="file" class="foto_utama @error('foto_utama') is-invalid @enderror" id="foto_utama"
											name="foto_utama" accept="image/png, image/jpeg" hidden>
									</label>
									<img src="{{ asset('storage/defaultImage.png') }}" alt="default-image" class="d-block rounded" height="100"
										id="uploadedFoto" />
