...
@section('content')
	<div class="row">
		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<form method="post" action="{{ route('admin.syaratppdb.update', $syarat->id) }}">
						@csrf
						@method('put')
						...
						<div class="row">
							<div class="col-sm-12 mb-3">
								...
								<div class="btn-group" role="group" aria-label="Basic example">
									<input type="radio" class="btn-check" name="status" value="dibuka" id="dibuka"
										{{ $syarat->status == 'dibuka' ? 'checked' : '' }}>
									<label class="btn btn-outline-primary text-capitalize" for="dibuka">Dibuka</label>

									<input type="radio" class="btn-check" name="status" value="ditutup" id="ditutup"
										{{ $syarat->status == 'ditutup' ? 'checked' : '' }}>
