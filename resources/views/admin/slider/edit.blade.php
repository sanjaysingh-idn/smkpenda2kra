...
@section('content')
	<div class="row">
		...
		<div class="col-12">
			<a href="/admin/slider" class="btn btn-secondary my-2">
				<< Kembali </a>
		</div>
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="{{ route('admin.slider.update', $slider->id) }}" enctype="multipart/form-data">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-12 mb-3">
									...
									<input type="text" class="form-control @error('text') is-invalid @enderror" name="text" id="text"
										value="{{ $slider->text }}">
									@error('text')
								...
								<div class="col-sm-6 mb-3">
									...
									<img src="{{ asset('storage/' . $slider->foto) }}" alt="Foto {{ $slider->text }}" class="img-thumbnail w-50">
									<br>
									<br>
									<label for="foto" class="btn btn-primary me-2 mb-4" tabindex="0">
										<span class="d-none d-sm-block">Upload Foto</span>
										<i class="bx bx-upload d-block d-sm-none"></i>
										<input type="file" class="foto @error('foto') is-invalid @enderror" id="foto" name="foto"
						...
						<div class="modal-footer">
							...
							<button type="submit" class="btn btn-primary"><i class="bx bx-save"></i> Edit Data</button>
						</div>
					</form>
				</div>
			</div>
