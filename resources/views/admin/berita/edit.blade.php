						...
						<div class="modal-body">
							<div class="row">
								...
								<div class="col-sm-6 mb-3">
									...
									<img src="{{ asset('storage/' . $berita->foto) }}" alt="Foto {{ $berita->judul }}" class="img-thumbnail w-50">
									<br>
									<br>
								...
								<div class="col-sm-12 mb-3">
									...
									<textarea class="form-control" name="content" id="desc" rows="5">{{ $berita->content }}</textarea>
								</div>
							</div>
						</div>
