...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->group(function () {
    Route::name('admin.')->group(function () {
        ...
        Route::get('/syaratppdb', [SyaratPendaftaranController::class, 'index'])->name('syaratppdb');
        Route::put('/syaratppdb/{id}/update', [SyaratPendaftaranController::class, 'update'])->name('syaratppdb.update');
        Route::get('/syaratppdb/{id}/dibuka', [SyaratPendaftaranController::class, 'dibuka'])->name('syaratppdb.dibuka');
        Route::get('/syaratppdb/{id}/ditutup', [SyaratPendaftaranController::class, 'ditutup'])->name('syaratppdb.ditutup');
...
Route::get('pendaftaran', [BerandaController::class, 'show_pendaftaran'])->name('pendaftaran');
// Halaman Home
